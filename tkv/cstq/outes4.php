...
$strSQL = 
("
SELECT t2.mt as LastTime,RIGHT(t1.src,10) as numb,t1.disposition,t1.dstchannel FROM 
(select *,RIGHT(src,10) as numb from cdr where calldate $strdate) as t1,
(select max(calldate) as mt,RIGHT(src,10) as numb from cdr where calldate $strdate group by src) as t2 
